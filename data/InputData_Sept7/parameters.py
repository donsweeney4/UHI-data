...
input_directory = 'InputData_Sept7'  # Replace with your directory path
output_directory = 'OutputData_Sept7'  # Replace with your directory path
start_time = '2024-09-07 13:41:15'
end_time = '2024-09-07 14:37:00'
...
temperature_drift =   +.000281  #  Positive value as temperature gets hotter over time
color_table_min = 35.35 #19.   # enter 0.0 to use floor of minimum temperature in data
color_table_max = 37.5 #29.   # enter 0.0 to use ceiling of maximum temperature in data
