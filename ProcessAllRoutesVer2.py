...
# df_step2 defined  ---  Filter out the slow speed data
                ...
                df_step2 = df_step1[df_step1['speed'] >= 1]  # 

                #df_eliminate_slow_speed.to_csv('filtered_speed.csv', index=False)
                print(f"     Total number of rows with speed above 1 MPH: {len(df_step2)}_")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("  Example: python ProcessAllRoutesVer2.py  InputData_March15")